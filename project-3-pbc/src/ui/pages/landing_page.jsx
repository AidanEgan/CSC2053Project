    ...
    render () {
        return (
            <React.Fragment>
                ...
                <a className='paddingSides' href='https://community.fangraphs.com/what-is-a-run-worth/' target="_blank">What is a Run Worth?</a>
                ...
                using the logic of Kyle Gipe in his article where he estimated that around 5 goals is equal to a win. I then divided 
